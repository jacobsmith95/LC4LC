  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans ">
      <main className="flex min-h-screen w-full max-w-6xl flex-col items-center justify-between py-32 px-16 bg-white sm:items-start">
        <header className="max-w-5xl text-3xl text-center font-bold leading-10 tracking-tight text-black">
          Get 'er Done With Joy Equus Life Coaching
        </header>
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          <h1 className="max-w-5xl text-5xl font-semibold leading-10 tracking-tight text-black">
